            ...
            <div className={styles.content.wrapper}>
                ...
                <h1 className={styles.content.headline.wrapper}>
                    <span className={styles.content.headline.row}>
                        <motion.span
                            className={`${styles.content.headline.text} text-white text-[clamp(2rem,6vw,6rem)]`}
                            initial={{ y: "100%" }}
                            animate={{ y: 0 }}
                    ...
                    <span className={styles.content.headline.row}>
                        <motion.span
                            className={`${styles.content.headline.text} text-transparent bg-clip-text bg-gradient-to-b from-white to-white/40 text-[clamp(2rem,6vw,6rem)]`}
                            initial={{ y: "100%" }}
                            animate={{ y: 0 }}
